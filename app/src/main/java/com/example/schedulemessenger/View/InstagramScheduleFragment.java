...
import com.example.schedulemessenger.databinding.FragmentInstagramScheduleBinding;
...
public class InstagramScheduleFragment extends Fragment {
    ...
    private FragmentInstagramScheduleBinding instagramScheduleBinding;
    ...
    public InstagramScheduleFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        instagramScheduleBinding = FragmentInstagramScheduleBinding.inflate(inflater, container, false);
        return instagramScheduleBinding.getRoot();// Inflate the layout for this fragment
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable final Bundle savedInstanceState) {
        ...
        instagramScheduleBinding.dateButton.setOnClickListener(new View.OnClickListener() {
        ...
        instagramScheduleBinding.timeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                timeInputHandler();
            }
        ...
        instagramScheduleBinding.sendButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                String instaUsername = instagramScheduleBinding.instaUsernameEditText.getText().toString().trim();
                String messageText = instagramScheduleBinding.messageEditText.getText().toString();
    ...
    private void scheduleInstaJobService() {
